...
# Data frame with kinetic energy (MeV), beta and charge per machine and projectile, ionization potential(keV), principal quantum number
data_projectile =  [['He1', 4.2,67.02, 5722.74, 0.094612,0.360286,0.99,1, 1, 2, 2, 24.6, 1],
                    ...
                    ['Mg6', 4.2,67.09, 5723.75, 0.094672,0.360686,0.99,6, 6, 12,12,7.618,3],
                    ['Mg7', 4.2,90.24, 6812.68, 0.094672,0.411251,0.99,7, 7, 12,12,7.618,3],
