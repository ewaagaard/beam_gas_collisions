...
# -*- coding: utf-8 -*-
"""
Estimate lifetimes for U28+ as compared to this study by Weber (2009): https://link.aps.org/doi/10.1103/PhysRevSTAB.12.084201
"""
import numpy as np
import pandas as pd
...
ax.plot(energy_array , tau_values_U28,  color='purple', label='Semi-empirical formula')
